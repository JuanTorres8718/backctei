export const queries = {
  ...
  editTalent:
    "UPDATE dbctei.talento_humano SET nombre_persona = @nombre_persona, objeto_contrato = @objeto_contrato, fecha_inicio_contrato = @fecha_inicio_contrato, fecha_fin_contrato = @fecha_fin_contrato, genero = @genero, tiempo_dedicacion_semanal = @tiempo_dedicacion_semanal, valor_mensual_contrato = @valor_mensual_contrato, valor_total_contrato = @valor_total_contrato, sena_sennova = @sena_sennova, codigo_nivel = @codigo_nivel, codigo_tipo_contrato = @codigo_tipo_contrato, codigo_rol_sennova = @codigo_rol_sennova, codigo_rol_proyecto = @codigo_rol_proyecto, codigo_estado_contrato = @codigo_estado_contrato WHERE codigo_talento = @codigo_talento",
  deleteTalent:
